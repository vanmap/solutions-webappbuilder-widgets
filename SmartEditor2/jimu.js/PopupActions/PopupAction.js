define([
  ...
  return declare([_WidgetBase, Evented], {
    ...
    _addButtonNodeToPopup: function() {
      ...
      this.popupButtonNode = html.create('a', {
        "class": "action " + this.buttonInfo.baseClass,
        "href": " javascript:void(0);"
      }, actionListNode);
      this.buttonDomNodes.push(this.popupButtonNode);

      var popupButtonNodeSpan = html.create('span', {
        "innerHTML": this.buttonInfo.label
      }, this.popupButtonNode);

      this.own(on(popupButtonNodeSpan,
        "click",
    ...
    _addButtonNodeToPopupMobile: function() {
      ...
      this.popupMobileButtonNode = html.create('a', {
        "class": "action " + this.buttonInfo.baseClass,
        "href": " javascript:void(0);"
      }, actionListNode);
      this.buttonDomNodes.push(this.popupMobileButtonNode);
      var popupMobileButtonNodeSpan = html.create('span', {
        "innerHTML": this.buttonInfo.label
      }, this.popupMobileButtonNode);

      this.own(on(popupMobileButtonNodeSpan,
        "click",
        lang.hitch(this, this._onButtonClick)));

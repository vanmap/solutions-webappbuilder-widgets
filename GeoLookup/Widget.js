...
define(['dojo/_base/declare',
    ...
    function (
        ...
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            longFieldStrings: ['lon', 'long', 'longitude', 'x', 'xcenter', 'point_y'],
            csvStore: null,
            layerLoaded: false,
            ...
            _buildRenderer: function () {
                ...
                var sym1 = symbolJsonUtils.fromJson(this.config.SymbolWithin);
                var sym2 = symbolJsonUtils.fromJson(this.config.SymbolOutside);
                this.renderer = new UniqueValueRenderer(sym1, this.nls.valueIn);
                this.renderer.addValue(this.nls.valueIn, sym1);
                this.renderer.addValue(this.nls.valueOut, sym2);
                    ...
                    syncDet = new layerQueryDetails(
                        {
                            ...
                            'fields': fields,
                            'intersectField': this.nls.intersectField,
                            'valueIn': this.nls.valueIn,
                            'valueOut': this.nls.valueOut
            ...
            _generateFeatureCollectionTemplateCSV: function (store, items) {
                ...
                this.combinedFields.push(this.nls.intersectField);

                array.forEach(this.combinedFields, function (field) {

                    var value = store.getValue(items[0], field);
                    var parsedValue = Number(value);
                    if (isNaN(parsedValue) || field === this.nls.intersectField) {

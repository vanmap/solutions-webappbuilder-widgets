    ...
    return declare([BaseWidget], {
        ...
        */
        _setResultListHeight: function () {
            ...
            if (this.domNode && this.domNode.parentElement && this.domNode.parentElement.parentElement) {
                containerGeom = domGeom.position(this.domNode.parentElement.parentElement);
                if (containerGeom && containerGeom.h) {
                    domStyle.set(this.resultListContainer, "max-height", (containerGeom.h - 270) + "px");
                }
            }
        },
        ...
        _createResultPanelButtons: function () {
            ...
            on(this.clearButton, "click", lang.hitch(this, function () {
                ...
                for (j = 0; j < this.tabContainer.controlNodes.length; j++) {
                    if (this.tabContainer.controlNodes[j].innerHTML === this.nls.searchContainerHeading) {
        ...
        */
        _initSortOrder: function () {
            ...
            on(document.body, "click", lang.hitch(this, function (event) {
                ...
                if (!(this.sortOrderIcon === target || this.ascendingButton === target || this.descendingButton === target)) {
                    if (this.sortOrderTooltipDialog.isOpen) {
                        this._hideTooltipDialog();
                    }
                }
        ...
        **/
        _initializingFindNearestOptions: function () {
            var findNearestOptions, arrayFindNearestOptions, k, labelDiv, labelValue, selectOptionArr = [], selectListDiv;
            if (this.config && this.config.accessPointsLayersName) {
                ...
                for (k = 0; k < arrayFindNearestOptions.length; k++) {
                    if (arrayFindNearestOptions.hasOwnProperty(k)) {
                        selectOptionArr.push({ "label": arrayFindNearestOptions[k], "value": arrayFindNearestOptions[k] });
                    }
                }
                selectListDiv = domConstruct.create("div", { "class": "esriCTFindNearestDropdown" }, this.selectFindNearest);
                this.findNearestList = new Select({ "options": selectOptionArr }, selectListDiv);
                ...
                on(this.findNearestList, "change", lang.hitch(this, function (value) {
        ...
        **/
        _createRouteFeatureLayer: function () {
            var routeSymbolData, featureCollection = {}, lineSymbol, rendererObj, outFields = [];
            this.outfields = [];
            ...
            featureCollection.layerDefinition = {
                ...
                "name": "Route Layer",
                "type": "Feature Layer",
                "displayField": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.displayField : "",
                "description": "",
                "copyrightText": "",
                "relationships": [],
                "geometryType": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.geometryType : "esriGeometryPolyline",
                "minScale": 0,
                "maxScale": 0,
                "extent": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.fullExtent : null,
                "drawingInfo": {
                ...
                "objectIdField": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.objectIdField : "",
                "globalIdField": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.globalIdField : "",
                "typeIdField": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.typeIdField : "",
                "fields": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.fields : [],
                "types": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.types : "",
                "templates": this.routeLayer && this.routeLayer.layerObject ? this.routeLayer.layerObject.templates : "",
        ...
        **/
        _initializingAttributeParameterValues: function () {
            var attributeParameterValues, i, arrayindex, index, attributeindex;
            ...
            for (i = 0; i < attributeParameterValues.length; i++) {
                ...
                if (attributeParameterValues[i].type === "Restriction" && attributeParameterValues[i].allowUserInput) {
                    ...
                    for (index in attributeParameterValues[i].parameters) {
                        ...
                        if (attributeParameterValues[i].parameters.hasOwnProperty(index)) {
                            // if index is greater than 0 as on 0th index always allow user input value will exist
                            if (index > 0) {
                                this._createRangeSlider(attributeParameterValues[i], i, index);
                            }
                        }
                    }
                } else if (attributeParameterValues[i].type === "" && attributeParameterValues[i].allowUserInput) {
                    arrayindex = 0;
                    this._createRangeSlider(attributeParameterValues[i], i, arrayindex);
                } else {
                    // loop for traversing parameters in attributes parameters
                    for (attributeindex in attributeParameterValues[i].parameters) {
                        // if object array have index property then only
                        if (attributeParameterValues[i].parameters.hasOwnProperty(attributeindex)) {
                            this.attributeValues.push({ "attributeName": attributeParameterValues[i].name, "parameterName": attributeParameterValues[i].parameters[attributeindex].name, "parameterValue": attributeParameterValues[i].parameters[attributeindex].value });
                        }
                    }
        ...
        * @memberOf widgets/ServiceFeasibility/Widget
        **/
        _createRangeSlider: function (attributeParameterValue, attrIndex, paramIndex) {
            var tempValue, maxValue, minValue, textbox, slider, businessContainer, influenceInput, buisnessInfluenceSlider;
            if (attributeParameterValue.parameters[paramIndex] && attributeParameterValue.parameters[paramIndex].value) {
                tempValue = (attributeParameterValue.parameters[paramIndex].value.split(","));
            }
            ...
            textbox = new NumberTextBox({ "name": attributeParameterValue.parameters[paramIndex].name, "id": attributeParameterValue.parameters[paramIndex].name, "value": minValue, "class": "esriCTTxtboxParamValue esriCTAttributeParamsValueTextbox", "required": true, "trim": true, "intermediateChanges": true, "constraints": { min: minValue, max: maxValue} });
            slider = new HorizontalSlider({ "class": "esriCTSlider", "name": "slider", "id": attributeParameterValue.parameters[paramIndex].name + attrIndex + "Slider", "value": minValue, "minimum": minValue, "maximum": maxValue, "discreteValues": maxValue + 1 });
            slider.startup();
            domAttr.set(textbox.domNode, "title", attributeParameterValue.parameters[paramIndex].name);

            domAttr.set(textbox.domNode, "name", attributeParameterValue.parameters[paramIndex].name);
            domAttr.set(textbox.domNode, "attributeName", attributeParameterValue.name);

            this._attachTextBoxEvents(textbox, slider, minValue, maxValue);

            if (paramIndex > 0) {
                businessContainer = domConstruct.create("div", { "class": "esriCTBusinessInfluence esriCTMarginL25" });
                domConstruct.create("div", { "class": "esriCTBusinessInfluenceValue", "innerHTML": attributeParameterValue.parameters[paramIndex].name, "title": attributeParameterValue.parameters[paramIndex].name }, businessContainer);

            } else {
                businessContainer = domConstruct.create("div", { "class": "esriCTBusinessInfluence" });
                domConstruct.create("div", { "class": "esriCTBusinessInfluenceValue", "innerHTML": this.resultPanelIndex + ". " + attributeParameterValue.parameters[paramIndex].name, "title": attributeParameterValue.parameters[paramIndex].name }, businessContainer);
                this.resultPanelIndex = (this.resultPanelIndex + 1);
            }
        ...
        **/
        _createDropDown: function (attributeParameterValues, index) {
            var selectValue, selectOptionArray, selectContainer, selectDropdownList, k, selectOptionArr = [], optionArray, attributeParamList;
            selectContainer = domConstruct.create("div", { "class": "esriCTBusinessDropdownContainer" }, this.divBuisnessInfluence);
            domConstruct.create("div", { "class": "esriCTBusinessDropdownLabel esriCTEllipsisForLabel", innerHTML: this.resultPanelIndex + ". " + attributeParameterValues.name, "title": attributeParameterValues.name }, selectContainer);
            this.resultPanelIndex = (this.resultPanelIndex + 1);
            selectDropdownList = domConstruct.create("div", { "class": "esriCTBusinessDropdownValue" }, selectContainer);
            attributeParamList = domConstruct.create("div", { "class": "esriCTBusinessDropdownValue" }, selectDropdownList);
            ...
            selectValue = new Select({ "id": attributeParameterValues.name + index, "options": selectOptionArr, "class": "esriCTDropdownValues esriCTAttributeParamsVal", "name": attributeParameterValues.name }, attributeParamList);
            domClass.add(selectValue, "esriCTAttributeParamsVal");
            domAttr.set(selectValue, "title", attributeParameterValues.parameters[0].name);
            domAttr.set(selectValue.domNode, "name", attributeParameterValues.name);
            domAttr.set(selectValue.domNode, "attributeName", attributeParameterValues.name);
            domAttr.set(selectValue.domNode, "defaultValue", attributeParameterValues.parameters[0].value);
            on(selectValue, "change", lang.hitch(this, function (selectedVal) {
                // enable the find button when disabled and when location is already added to map
        ...
        **/
        _checkParameterValues: function () {
            var i, numberTxtNode, dropDownCount, numberTxtbox, numberSliderNode, numberSliderbox;
            if (this.businessInfluenceValue) {
                this.businessInfluenceValue.length = 0;
            }
            ...
            array.forEach(numberTxtNode, lang.hitch(this, function (node) {
                numberTxtbox = query(".dijitReset .dijitInputInner", node);
                this.businessInfluenceValue.push({ "parameterValue": numberTxtbox[0].value, "parameterName": node.title, "attributeName": domAttr.get(node, "attributeName") });
            ...
            array.forEach(dropDownCount, lang.hitch(this, function (dropDown) {
                if (dropDown) {
                    this.businessInfluenceValue.push({ "parameterValue": dropDown.textContent, "parameterName": dropDown.title, "attributeName": domAttr.get(dropDown, "attributeName") });
                }
            }));
            ...
            array.forEach(numberSliderNode, lang.hitch(this, function (sliderNode) {
            ...
            array.forEach(numberTxtNode, lang.hitch(this, function (inputNode) {
                // if inputNode parent node found then only
                if (inputNode) {
                    numberTxtbox = query(".dijitReset .dijitInputInner", inputNode);
        ...
        _onPointBarrierClicked: function () {
            if (!this.pointBarrierClicked) {
                ...
                if (this.viewWindowSize.w < 768) {
                    if (this.panelManager.getPanelById(this.id + '_panel').titleNode && this.panelManager.getPanelById(this.id + '_panel').onTitleClick) {
        ...
        **/
        _onClearButtonClicked: function () {
            if (!this.clearButtonSearch.disabled || this.errorExist) {
                ...
                if (this.config.businessesLayerName !== this.config.targetBusinessLayer && this.findNearestList.value.toString() !== this.config.businessesLayerName) {
        ...
        **/
        _resetBusinessInfluenceValues: function () {
            var resettxtbox, numberTxtbox, numberSliderNode, numberSliderbox, numberTextbox, attrParamSelectArray, defaultValue, attrParamSelect;
            ...
            array.forEach(resettxtbox, lang.hitch(this, function (inputNode) {
                // if inputNode parent node found then only
                if (inputNode) {
                    numberTextbox = query(".dijitReset .dijitInputInner", inputNode);
                    // if inputNode node found inside inputNode parent node then disable it
                    if (numberTextbox) {
            ...
            array.forEach(attrParamSelectArray, lang.hitch(this, function (selectNode) {
                // if inputNode parent node found then only
                if (selectNode) {
        ...
        **/
        _createBufferGeometry: function (geometry, distance, unit, wkid) {
            ...
            try {
                geometryBufferEng = geometryEngine.buffer(geometry, distance, unit, true);
                if (geometryBufferEng && geometryBufferEng.length > 0 && geometryBufferEng[0] && geometryBufferEng[0].rings.length > 0) {
        ...
        **/
        _getResultantRoutes: function (results) {
            var facilityParams, incidents, facilities, locationGraphics, features = [], attributeParameterValues = [], pointLocation, closestFacilityTask, i, errorMsg = "";
                ...
                if (this.businessInfluenceValue.length > 0) {
                    for (i = 0; i < this.businessInfluenceValue.length; i++) {
                        attributeParameterValues.push({
                            ...
                            value: this.businessInfluenceValue[i].parameterValue.toString()
                        });
                    }
            ...
            return closestFacilityTask.solve(facilityParams, lang.hitch(this, function (solveResults) {
                if (solveResults && solveResults.routes && solveResults.routes.length > 0 && solveResults.routes[0]) {
                ...
                this.errorExist = true;
                this._onClearButtonClicked();
                errorMsg = (error && error.message ? error.message : "") + (error.details && error.details.length > 0 ? "\n" + error.details[0] : "");
        ...
        **/
        _setAttributeParameterValues: function () {
            var attributeParameterValues = [], i, j;
            if (this.businessInfluenceValue) {
                if (this.businessInfluenceValue.length > 0) {
                    // loop to push the each business influence value and each attributeName in attributeParameterValues
                    for (i = 0; i < this.businessInfluenceValue.length; i++) {
            ...
            if (this.config && this.config.attributeName && this.config.attributeName.length > 0) {
                ...
                for (j = 0; j < this.config.attributeName.length; j++) {
                    if (this.config.attributeName[j].value !== "" && this.config.attributeName[j].allowUserInput === "false") {
                        attributeParameterValues.push({
        ...
        **/
        _getFacilityParameters: function () {
            var facilityParams, pointbarriers, polylineBarriers, polygonBarriers, pointBarriersArr = [], polylineBarriersArr = [], polygonBarriersArr = [];
            ...
            if (this.pointBarriersArray && this.pointBarriersArray.length > 0) {
                ...
                array.forEach(this.pointBarriersArray, lang.hitch(this, function (geom) {
            ...
            if (this.polylineBarriersArray && this.polylineBarriersArray.length > 0) {
                ...
                array.forEach(this.polylineBarriersArray, lang.hitch(this, function (geom) {
            ...
            if (this.polygonBarriersArray && this.polygonBarriersArray.length > 0) {
                ...
                array.forEach(this.polygonBarriersArray, lang.hitch(this, function (geom) {
        ...
        **/
        _showFinalRoute: function (routes) {
            var lineSymbol, finalRoute, pathLine, routeSymbolData, routeLayerInfos = [], routeFieldInfo = [];
            ...
            if (this.config && this.config.symbol && this.config.symbol.length && this.config.symbol.length > 0) {
                ...
                if (routes.geometry && routes.geometry.paths && routes.geometry.paths.length > 0) {
                    pathLine.addPath(routes.geometry.paths[0]);
                    finalRoute = new Graphic(pathLine, lineSymbol);
                    finalRoute.attributes = {};
                    finalRoute.attributes[this.routeFeatureLayer.objectIdField] = "1";
                    // clear the route graphic layer before adding new graphic
                    if (this.routeFeatureLayer) {
                        if (this.routeFeatureLayer.graphics && this.routeFeatureLayer.graphics.length > 0) {
                        ...
                        on(this.attInspector, "attribute-change", lang.hitch(this, function (evt) {
                            if (this.routeFeatureLayer.graphics.length > 0) {
                                if (evt.fieldName === this.config.FieldMappingData.routeLayerField) {
                                    this._changeInField = true;
                                }
                                if (evt.fieldValue !== null && evt.fieldValue !== undefined && (evt.fieldValue === "NaN" || evt.fieldValue.toString() !== "NaN")) {
                                    this.routeFeatureLayer.graphics[0].attributes[evt.fieldName] = evt.fieldValue;
                                } else if (evt.fieldValue !== undefined) {
                                    this.routeFeatureLayer.graphics[0].attributes[evt.fieldName] = null;
                                }
                            }
                        }));
                    }
        ...
        **/
        _setLayerForDropdown: function (value) {
            ...
            for (j = 0; j < this.map.itemInfo.itemData.operationalLayers.length; j++) {
                if (this.map.itemInfo.itemData.operationalLayers[j].title === value) {
                ...
                if (this.config && this.config.targetRouteLayer) {
                    if (this.map.itemInfo.itemData.operationalLayers[j].title === this.config.targetRouteLayer) {
                        this.routeLayer = this.map.itemInfo.itemData.operationalLayers[j];
                    }
                }
            }
        },
        ...
        **/
        _checkLayerAvailability: function (layerTitle) {
            var isLayerAvailable = false, j;
            for (j = 0; j < this.map.itemInfo.itemData.operationalLayers.length; j++) {
                if (this.map.itemInfo.itemData.operationalLayers[j].title === layerTitle) {
        ...
        **/
        _validateEditCapabilities: function (layerTitle) {
            var layerCapabilities, isLayerEditable = false, j;
            for (j = 0; j < this.map.itemInfo.itemData.operationalLayers.length; j++) {
                if (this.map.itemInfo.itemData.operationalLayers[j].title === layerTitle) {
                    layerCapabilities = this.map.itemInfo.itemData.operationalLayers[j].resourceInfo.capabilities;
                    ...
                    } else if (layerCapabilities && layerCapabilities.indexOf("Create") > -1 && layerCapabilities.indexOf("Editing") > -1) {
        ...
        **/
        _setRouteAttributes: function () {
            if (this.routeFeatureLayer && this.routeFeatureLayer.graphics.length > 0) {
                if (this.config.saveRoutelengthField && lang.trim(this.config.saveRoutelengthField) !== "") {
                    this.routeFeatureLayer.graphics[0].attributes[this.config.saveRoutelengthField] = this._routeLength;
                }
                if (this.config.saveBusinessCountField && lang.trim(this.config.saveBusinessCountField) !== "") {
                    this.routeFeatureLayer.graphics[0].attributes[this.config.saveBusinessCountField] = this._businessPassed;
                }
            }
        },
        ...
        **/
        _queryForObjectIds: function (businessIds) {
            var batchIds = [], batch, startIdx, endIdx, deferredArray = [], i;
            this.resultDisplayAttributes = [];
            this.results = [];
        ...
        **/
        _businesspassedAscOrder: function () {
            domConstruct.empty(this.resultListContainer);
            if (this.config.businessDisplayField && this.resultDisplayAttributes.length > 0) {
                this.resultDisplayAttributes = this.resultDisplayAttributes.sort(lang.hitch(this, function (a, b) {
                    return (a.attributes[this.config.businessDisplayField] < b.attributes[this.config.businessDisplayField]) ? -1 : (a.attributes[this.config.businessDisplayField] > b.attributes[this.config.businessDisplayField]) ? 1 : 0;
                }));
                this.resultDisplayField = this.resultDisplayField.sort(function (a, b) {
        ...
        **/
        _createResultGrid: function (displayList, resultFeatures) {
            ...
            domConstruct.empty(this.exportToCSVContainer);
            saveExportDiv = domConstruct.create("div", { "class": "esriCTSaveExportBtnDiv" }, this.exportToCSVContainer);
            ...
            for (m = 0; m < displayList.length; m++) {
                list = domConstruct.create("div", { "class": "esriCTFeatureFieldContainer", "innerHTML": displayList[m].name, "id": displayList[m].objectId }, this.resultListContainer);
        ...
        **/
        _attachEventsToResultListContainer: function (resultFeatures, list) {
            ...
            this.own(on(list, "click", lang.hitch(this, function (evt) {
                ...
                this._highlightFeatureOnMap(selectedFeature, resultFeatures, featureId);
            })));
        ...
        * @memberOf widgets/ServiceFeasibility/Widget
        **/
        _highlightFeatureOnMap: function (selectedFeature, resultFeatures, featureId) {
            var m, rippleGraphic, featureGeometry, featureDisplayField;
            for (m = 0; m < resultFeatures.length; m++) {
                featureDisplayField = resultFeatures[m].attributes[this.config.businessDisplayField];
                if (featureDisplayField !== null && featureDisplayField !== undefined && featureDisplayField !== "") {
                    if ((resultFeatures[m].attributes[this.config.businessDisplayField].toString()) === selectedFeature && (resultFeatures[m].attributes[this.businessLayer.layerObject.fields[0].name].toString()) === featureId) {
                        this.highlightGraphicLayer.clear();
            ...
            try {
                setTimeout(lang.hitch(this, function () {
                    ...
                    if (this.resultDisplayAttributes.length > 0) {
                        if (this.businessLayer && this.businessLayer.layerObject && this.businessLayer.layerObject.fields) {
                            for (key in this.resultDisplayAttributes[0].attributes) {
                                if (this.resultDisplayAttributes[0].attributes.hasOwnProperty(key)) {
                                    for (i = 0; i < this.businessLayer.layerObject.fields.length; i++) {
                                        resultField = this.businessLayer.layerObject.fields[i];
                        ...
                        for (i = 0; i < this.resultDisplayAttributes.length; i++) {
                            fieldAttributes = this._addFieldAttributesValue(i, dateFields);
                            csvContent += fieldAttributes.join(",") + csvNewLineChar;
                        }
                    }
                    this._onExportToCsvComplete(this.businessLayer.title, csvContent);
                }, 1000));
        ...
        **/
        _addFieldAttributesValue: function (i, dateFields) {
            var fieldAttributes = [], value, textField = '"';
            array.forEach(this.businessLayer.layerObject.fields, lang.hitch(this, function (field) {
                if (this.resultDisplayAttributes[i].attributes.hasOwnProperty(field.name)) {
                    value = this.resultDisplayAttributes[i].attributes[field.name];
        ...
        **/
        _onExportToCsvComplete: function (layerName, csvData) {
            ...
            if (this.IsIE) {
                ...
                link = domConstruct.create("a", { href: 'data:attachment/csv;charset=utf-8,' + encodeURIComponent(csvData), target: '_blank', download: layerName + ".csv" }, this.domNode);
                if (this.IsSafari) {
        ...
        **/
        _showFieldsToEdit: function () {
            ...
            if (this.routeFeatureLayer && this.routeFeatureLayer.graphics.length > 0 && this.routeFeatureLayer.objectIdField && this.routeFeatureLayer.objectIdField !== "") {
                selectQuery.objectIds = [this.routeFeatureLayer.graphics[0].attributes[this.routeFeatureLayer.objectIdField]];
                this.routeFeatureLayer.selectFeatures(selectQuery, this.routeLayer.layerObject.SELECTION_NEW, null, lang.hitch(this, function (err) {
                    if (err) {
                        this._showAlertMessage(err.message);
                    }
                }));
        ...
        _filterRouteLayerFieldInfo: function () {
            ...
            if (this.routeLayer && this.routeLayer.title) {
                for (j = 0; j < this.map.webMapResponse.itemInfo.itemData.operationalLayers.length; j++) {
                    for (i = 0; i < this.map.webMapResponse.itemInfo.itemData.operationalLayers[j].popupInfo.fieldInfos.length; i++) {
                        if (this.map.webMapResponse.itemInfo.itemData.operationalLayers[j].title === this.routeLayer.title) {
                            if (this.map.webMapResponse.itemInfo.itemData.operationalLayers[j].popupInfo.fieldInfos[i].isEditable) {
                                fieldInfoArr.push(this.map.webMapResponse.itemInfo.itemData.operationalLayers[j].popupInfo.fieldInfos[i]);
                            }
                        }
                    }
                }
        ...
        **/
        _setDisplayForPanels: function () {
            ...
            if (this.saveLayerClicked) {
                ...
                domClass.replace(this.divExportToLayerButtons, "esriCTHidePanel", "esriCTShowPanel");
        ...
        **/
        _onSaveBtnClick: function () {
            var businessLayer, routeLayer, isBusinessLayerSave = false, isRouteLayerSave = false, i, j;
            this.showLoadingIndicator();
        ...
        **/
        _addDataInBusinessLayer: function (businessLayer, routeLayer) {
            if (routeLayer && this.routeFeatureLayer && this.routeFeatureLayer.graphics.length > 0) {
                array.forEach(this.businessGraphicArray, lang.hitch(this, function (feature) {
                    if (feature) {
                        feature.attributes[this.config.FieldMappingData.bussinessLayerField] = this.routeFeatureLayer.graphics[0].attributes[this.config.FieldMappingData.routeLayerField];
                    }
                }));
            }
            if (this.businessGraphicArray && this.businessGraphicArray.length > 0) {
        ...
        **/
        _addToBusinessLayer: function (businessLayer, routeLayer) {
            ...
            businessLayer.applyEdits(this.businessGraphicArray, null, null, lang.hitch(this, function (results) {
                businessLayerSuccess = results && results.length > 0 && results[0].success ? true : false;
                if (routeLayer && this.checkedLayers.length === 2) {
                    this._addDataInRouteLayer(routeLayer, businessLayerSuccess);
                }
                if (results && results.length > 0 && results[0].success) {
                    ...
                    if (this.checkedLayers.length === 1) {
                        this.saveLayerClicked = false;
                        this._setDisplayForPanels();
                        this._showAlertMessage(string.substitute(this.nls.saveToLayerSuccess, [this.nls.businessLayerLabel]));
                        this._hideLoadingIndicator();
                    }
                } else {
                    this._showAlertMessage(string.substitute(this.nls.saveToLayerFailed, [this.nls.businessLayerLabel]));
                    this._hideLoadingIndicator();
                }
            }), lang.hitch(this, function (error) {
                if (this.checkedLayers.length === 1) {
        ...
        **/
        _updateBusinessLayer: function (businessLayer, routeLayer) {
            var businessLayerSuccess;
            businessLayer.applyEdits(null, this.businessGraphicArray, null, lang.hitch(this, function (addResults, updateResults, delResults) {
                businessLayerSuccess = updateResults && updateResults.length > 0 && updateResults[0].success ? true : false;
                if (routeLayer && this.checkedLayers.length === 2) {
                    this._addDataInRouteLayer(routeLayer, businessLayerSuccess);
                }
                if (updateResults && updateResults.length > 0 && updateResults[0].success) {
                    businessLayer.refresh();
                    if (this.checkedLayers.length === 1) {
                        this.saveLayerClicked = false;
                        this._setDisplayForPanels();
        ...
        _addDataInRouteLayer: function (routeLayer, businessLayerSuccess) {
            if (this.routeFeatureLayer && this.routeFeatureLayer.graphics.length > 0) {
                if (!this._routeDataSaved) {
                    this._addToRouteFeatureLayer(routeLayer, businessLayerSuccess);
                } else {
                    this._updateRouteFeatureLayer(routeLayer, businessLayerSuccess);
                }
            }
        },
        /**
        ...
        **/
        _addToRouteFeatureLayer: function (routeLayer, businessLayerSuccess) {
            ...
            routeGraphic = new Graphic(this.routeFeatureLayer.graphics[0].geometry, null, this.routeFeatureLayer.graphics[0].attributes);
            routeGraphic.attributes[this.routeFeatureLayer.objectIdField] = null;
            routeLayer.applyEdits([routeGraphic], null, null, lang.hitch(this, function (results) {
                this.saveLayerClicked = false;
                this._setDisplayForPanels();
                if (results && results[0] && results[0].success) {
                    ...
                    savedLayers = businessLayerSuccess && this.checkedLayers.length === 2 ? this.nls.saveRouteLayerLabel + ", " + this.nls.businessLayerLabel : this.nls.saveRouteLayerLabel;
                    this._showAlertMessage(string.substitute(this.nls.saveToLayerSuccess, [savedLayers]));
                    this._hideLoadingIndicator();
                } else {
                    this._showAlertMessage(string.substitute(this.nls.saveToLayerFailed, [this.nls.saveRouteLayerLabel]));
                    this._hideLoadingIndicator();
                }
            }), lang.hitch(this, function (error) {
                this.saveLayerClicked = false;
        ...
        **/
        _updateRouteFeatureLayer: function (routeLayer, businessLayerSuccess) {
            ...
            if (routeGraphic && routeGraphic.attributes) {
                routeGraphic.attributes[this.routeFeatureLayer.objectIdField] = this.resultId;
                routeLayer.applyEdits(null, [routeGraphic], null, lang.hitch(this, function (addResults, updateResults, delResults) {
                    this.saveLayerClicked = false;
                    this._setDisplayForPanels();
                    if (updateResults && updateResults[0] && updateResults[0].success) {
                        routeLayer.refresh();
                        savedLayers = businessLayerSuccess && this.checkedLayers.length === 2 ? this.nls.saveRouteLayerLabel + ", " + this.nls.businessLayerLabel : this.nls.saveRouteLayerLabel;
                        this._showAlertMessage(string.substitute(this.nls.saveToLayerSuccess, [savedLayers]));
                        this._hideLoadingIndicator();

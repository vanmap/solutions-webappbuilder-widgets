...
function(declare, array, html, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, on, query, Evented,
  lang, mouse, dojoPopup, TooltipDialog, DrawBox, _FeatureSetChooserCore) {
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    postCreate:function(){
      ...
      // var selectTipText = this.nls.selectByRectangle + ': ' +
      // this.nls.newSelectionTip + ' (' + this.nls.dragBox + '); ' +
      // this.nls.addSelectionTip + ' (Shift+' + this.nls.dragBox + '); ' +
      // this.nls.removeSelectionTip + ' (Ctrl+' + this.nls.dragBox + ').';
      // this.extentIcon.title = selectTipText;

      // this.btnClear.title = this.nls.unselectAllSelectionTip;
    ...
    _initTooltipDialogs: function(){
      ...
      '<div class="item">- ' + this.nls.newSelectionTip + ' (' + this.nls.dragBox + ')</div>' +
      '<div class="item">- ' + this.nls.addSelectionTip + ' (Shift+' + this.nls.dragBox + ')</div>' +
      '<div class="item">- ' + this.nls.removeSelectionTip + ' (Ctrl+' + this.nls.dragBox + ')</div>';
      ...
      // query('.item', tooltipDialogContent1).forEach(lang.hitch(this, function(tipItem){
      //   if(window.isRTL){
      //     tipItem.style.paddingRight = "20px";
      //   }else{
      //     tipItem.style.paddingLeft = "20px";
      //   }
      // }));

define([
  ...
  var PrintDijit = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    printMapBookCheck: function() {
      ...
      var mapBookPopup = new Popup({
        titleLabel: "MapSheet Print",
        width: 350,
        height: 350,
        content: mapBook,
        buttons: [{
          ...
          onClick: lang.hitch(this, function() {
            mapBook.finalSheetsToPrint();
            this.mapBookZoom({features: mapBook.finalPrintSet});
            mapBookPopup.close();
          })
        }, {
          label: "Cancel"
      ...
      if(pParam.features.length > 0) {
        ...
        this.map.setExtent(newExtent).then(lang.hitch(this, function() {
          var printEvt = this.printTask.on('complete', lang.hitch(this, function() {
            ...
            this.mapBookZoom({features: pParam.features});
            printEvt.remove();
          }));
          this.print();
        }));
    ...
    print: function() {
      if (this.printSettingsFormDijit.isValid()) {
        ...
        template.layoutOptions = {
          ...
          copyrightText: form.copyright || this._getMapAttribution(),

  ...
  return declare([_WidgetBase, Evented], {
    ...
    createToolbar: function() {
      ...
      this.clearSelectionButton = new Button({
        ...
        onClick: lang.hitch(this, this.clearSelection, true)
      });
    ...
    changeToolbarStatus: function() {
      ...
      if (this.tableCreated && this.isSupportQueryToServer()) {
    ...
    _doQuery: function(normalizedExtent, queryByStoreObjectIds) {
      ...
      if (this.isSupportQueryToServer()) {
        this._queryToServer(normalizedExtent, pk, selectionRows, queryByStoreObjectIds);
    ...
    _queryToServer: function(normalizedExtent, pk, selectionRows, queryByStoreObjectIds) {
        ...
        .then(lang.hitch(this, function(recordCounts) {
          ...
          if (queryByStoreObjectIds) {
            this._queryFeatureLayer(
              normalizedExtent, pk,
              selectionRows, recordCounts, false, queryByStoreObjectIds
            );
          } else {
    ...
    createTable: function(columns, store, recordCounts) {
      ...
      // this.allRecordsView = html.create('div', {
      //   'class': 'jimu-widget-attributetable-feature-table-view-all',
      //   innerHTML: 'A'
      // }, this.selectedRowsLabel, 'after');
      // this.selectRecordsView = html.create('div', {
      //   'class': 'jimu-widget-attributetable-feature-table-view-select',
      //   innerHTML: 'S'
      // }, this.allRecordsView, 'after');
            ...
            if (gExtent) {
              ...
              def.then(lang.hitch(this, function() {
                ...
                if (popup && popup.setFeatures && result.length === 1 && layerInfoTemplate) {
                  ...
                  // this.syncWithMapInfowindow(res);
                }
              }));
            }
          }), lang.hitch(this, function(err) {
    ...
    syncWithMapInfowindow: function(monitor) {
      ...
      on.once(popup, 'hide', lang.hitch(this, function() {
        ...
        var selectIds = this.getSelectedRows();

        if (this.domNode && hasSG && sgOid && selectIds.indexOf(sgOid) > -1) {
          this.clearSelection(this.showSelected ? true : false);
        }
        if (h && h.remove) {
          h.remove();
          h = null;
    ...
    _getIndexOfIdInGrid: function(id) {
      ...
      if (this.grid.store instanceof Memory) {
        ...
        dataIndex = this.grid.store.data.indexOf(obj);

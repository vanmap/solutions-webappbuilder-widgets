...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, lang, html,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    */
    ...
    getKeys: function(){
      var str = "shiftKey:" + this._shiftKey + ", ctrlKey:" + this._ctrlKey;
      return str;
    },
    ...
    onDrawEnd:function(graphic, geotype, commontype, shiftKey, ctrlKey){
      this.emit('draw-end', graphic, geotype, commontype, shiftKey, ctrlKey);
    },
    ...
    _onDrawEnd:function(event){
      ...
      this.onDrawEnd(g, geotype, commontype, this._shiftKey, this._ctrlKey);
    }

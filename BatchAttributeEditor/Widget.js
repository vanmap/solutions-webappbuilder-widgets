...
function (declare,
  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    applyCallback : function(chunks, idx, layer, syncDet) {
      var def;
      if (idx === 0) {
        def = layer.layerObject.applyEdits(null, chunks[idx], null, lang.hitch(this, this.applyCallback(chunks, idx + 1, layer, syncDet)), lang.hitch(this, this.applyErrorback(chunks, idx + 1, layer)));

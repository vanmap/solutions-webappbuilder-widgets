define({
  root: {
    ...
    validationErrorMessage: {
      ...
      outageFieldMappingErr: "Same field is mapped for two or more outputs. Field mapping to save summary of the output(s) must be unique.",
      ...
      otherHighlighterImageHeight: "Image height must not be less than 0 or blank.",
      otherHighlighterImageWidth: "Image width must not be less than 0 or blank.",
      otherHighlighterImageTimeout: "Image timeout must not be less than 0 or blank.",
      saveToLayerTargetLayers: "Target layer must be unique or cannot be blank.",
      displayTextForButtonError: "Display text for 'Run' button cannot be blank.",
      BufferDisatanceOverview: "Buffer distance must not be blank or 0 or less than 0.",

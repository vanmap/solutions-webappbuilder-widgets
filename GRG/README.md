# Grided Reference Graphic Widget
The Grided Reference Graphic Widget for Web AppBuilder for ArcGIS provides sector identifiers for easy categorization of specific areas within the Area of Operations. Coupled with numbered features, it is an easy and accurate way to both assign geographic areas and monitor progress among different units.
...
## Features
* Creates a Canvas GRG
* Creates a Point Target GRG

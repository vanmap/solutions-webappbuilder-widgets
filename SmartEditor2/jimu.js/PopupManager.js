...
define([
  ...
  './PopupActions/GetDirectionsAction'
  ], function(declare, lang, array, topic, _WidgetBase, RelatedRecordAction,
    EditAction, GetDirectionsAction) {
    var instance = null;
    var clazz = declare([_WidgetBase], {
      ...
      _addGetDirectionsAction: function() {
        var getDirectionsAction = new GetDirectionsAction({
        ...
        this.addAction(getDirectionsAction);
      },

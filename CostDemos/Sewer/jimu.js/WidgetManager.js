...
define(['dojo/_base/declare',
  ...
  function(declare, lang, array, html, Deferred, topic, Evented, on, aspect,
    json, query, xhr, all, utils, tokenUtils, Message, FeatureActionManager) {
    var instance = null,
      clazz = declare(Evented, {
        ...
        registerWidgetFeatureActions: function(widgetJson){
          ...
          array.forEach(widgetJson.featureActions, function(action){
            defs.push(this.featureActionManager.registerAction({
        ...
        _reRegisterWidgetActions: function(appConfig){
          ...
          array.forEach(this.featureActionManager.getAllActions(), function(action){
            var e = appConfig.getConfigElementById(action.widgetId);
            if(action.widgetId !== 'framework' && (!e || !e.uri)){
              this.featureActionManager.removeActionsByWidgetId(action.widgetId);
            }
          }, this);
          ...
          appConfig.visitElement(lang.hitch(this, function(e){
            if(e.uri && e.visible &&
              this.featureActionManager.getActionsByWidgetId(e.id).length === 0){
              defs.push(this.registerWidgetFeatureActions(e));
            }
          }));

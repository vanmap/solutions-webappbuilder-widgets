    ...
    return dojoDeclare(null, {
        ...
        getCoordinateType: function (fromInput) {
            ...
            var strs = [
                {
                    name: 'DD',
                    pattern: /^(([NnSs\+-])?([0-8]?\d([,.:]\d*)?|90([,.:]0*)?)([°˚º^~*]*)([NnSs\+-])?)([,:;\s|\/\\]+)(([EeWw\+-])?([0]?\d?\d([,.:]\d*)?|1[0-7]\d([,.:]\d*)?|180([,.:]0*)?)([°˚º^~*]*)([EeWw\+-])?)$/,
                    notationType: "DD - Latitude/Longitude"
                }, {
                    name: 'DDrev',
                    pattern: /^(([EeWw\+-])?([0]?\d?\d([,.:]\d*)?|1[0-7]\d([,.:]\d*)?|180([,.:]0*)?)([°˚º^~*]*)([EeWw\+-])?)([,:;\s|\/\\]+)(([NnSs\+-])?([0-8]?\d([,.:]\d*)?|90([,.:]0*)?)([°˚º^~*]*)([NnSs\+-])?)$/,
                    ...
                    name: 'DMS',
                    pattern: /^(([\+\-NnSs])?([0-8]?\d|90)[°˚º^~*\s\-_]+([0-5]?\d|\d)['′\s\-_]+(([0-5]?\d|\d)([,.:]\d*)?)["¨˝\s_]*([\+\-NnSs])?)([,:;\s|\/\\]+)(([\+\-EeWw])?([0]?\d?\d|1[0-7]\d|180)[°˚º^~*\s\-_]+([0-5]\d|\d)['′\s\-_]+(([0-5]?\d|\d)([,.:]\d*)?)["¨˝\s_]*([\+\-EeWw])?)[\s]*$/,
                    notationType: "DMS - Latitude/Longitude" 
                }, {
                    name: 'DMSrev',
                    pattern: /^(([\+\-EeWw])?([0]?\d?\d|1[0-7]\d|180)[°˚º^~*\s\-_]+([0-5]\d|\d)['′\s\-_]+(([0-5]?\d|\d)([,.:]\d*)?)["¨˝\s_]*([\+\-EeWw])?)([,:;\s|\/\\]+)(([\+\-NnSs])?([0-8]?\d|90)[°˚º^~*\s\-_]+([0-5]?\d|\d)['′\s\-_]+(([0-5]?\d|\d)([,.:]\d*)?)["¨˝\s_]*([\+\-NnSs])?)[\s]*$/,

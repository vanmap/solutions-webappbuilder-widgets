define({
  root: ({
    ...
    featureSetChooser: {
      select: "Select",
      dragBox: "Drag",
      dragMouse: "Darg the mouse",
      selectByRectangle: "Select By Rectangle",
      selectFeaturesTip: "Select features by dragging box around them on map",
      newSelectionTip: "Create a new selection",
      addSelectionTip: "Add to the current selection",
      removeSelectionTip: "Remove from the current selection",
    ...
    shareOptions: {
      ...
      shareMapTips: "Your map is currently shared with these people",
      everyone: "Everyone",
